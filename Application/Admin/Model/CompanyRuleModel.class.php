...
class CompanyRuleModel extends Model
{
	...
	public function __construct(){
		...
		$file_name="./Public/companyRule.xlsx";
	...
	public function ruleList(){
		...
		$rules = array();
		for($i=2;$i<=80;$i++){
			if($this->objPHPExcel->getActiveSheet()->getCell("A".$i)->getValue()){
				...
				$rules[$this->objPHPExcel->getActiveSheet()->getCell("A".$i)->getValue()]['arr'] = $this->objPHPExcel->getActiveSheet()->getCell("I".$i)->getValue();
			}
		}	
