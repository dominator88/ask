...
questionnaire = new Object({
	...
	loadQuestionnaire: function(questionnaireID){
		...
		return $.ajax({
			type: 'GET',
			url: '/index.php/WebService/questionnaires/' + questionnaireID + '.json',
			dataType: 'json',
	...
	loadQuestions: function(questionnaireID){
		...
		return $.ajax({
			type: 'GET',
			url: '/index.php/WebService/questionnaires/' + questionnaireID + '/questions.json',
			dataType: 'json',
		}).then(function(response){
	...
	loadJudgement: function(questionnaireID){
		...
		return $.ajax({
			type: 'GET',
			url: '/index.php/WebService/questionnaires/' + questionnaireID + '/judgement.json',
			dataType: 'json',
		}).then(function(response){
	...
	loadSignimages: function(questionnaireID){
		...
		return $.ajax({
			type: 'GET',
			url: '/index.php/WebService/questionnaires/' + questionnaireID + '/signimages.json',
			dataType: 'json',
		}).then(function(response){
	...
	submitReply: function(questionnaireID){
		...
		return $.ajax({
			type: 'POST',
			url: '/index.php/WebService/questionnaires/' + questionnaireID + '/reply.json',
